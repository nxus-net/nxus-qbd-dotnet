...
public class PaginationTests {
    private static readonly (string Name, Func<NxusClient, VoidableResourceBase> SelectResource, string Path)[] VoidableResourceCases = [
        ...
        ("CheckBillPayments", client => client.CheckBillPayments, "/api/v1/check-bill-payment/txn_123/void"),
        ("Checks", client => client.Checks, "/api/v1/check/txn_123/void"),
        ("CreditCardBillPayments", client => client.CreditCardBillPayments, "/api/v1/credit-card-bill-payment/txn_123/void"),
