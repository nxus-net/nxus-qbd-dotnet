...
namespace Nxus.Qbd.Models
{
    ...
    /// </summary>
    public partial class CreateItemDiscountRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CreateItemDiscountRequest(string name, Option<bool?> isActive = default, Option<string?> parentId = default, Option<string?> parentName = default, Option<string?> itemDesc = default, Option<string?> salesTaxCodeId = default, Option<string?> salesTaxCodeName = default, Option<double?> discountRate = default, Option<double?> discountRatePercent = default, Option<string?> accountId = default, Option<string?> accountName = default, Option<string?> externalId = default)
        {
            Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateItemDiscountRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateItemDiscountRequest" />
    /// </summary>
    public class CreateItemDiscountRequestJsonConverter : JsonConverter<CreateItemDiscountRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateItemDiscountRequest" />
        /// </summary>
        ...
        public override CreateItemDiscountRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class CreateItemDiscountRequest.", nameof(name));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class CreateItemDiscountRequest.");

            return new CreateItemDiscountRequest(name.Value!, isActive, parentId, parentName, itemDesc, salesTaxCodeId, salesTaxCodeName, discountRate, discountRatePercent, accountId, accountName, externalId);
        }

        /// <summary>
        /// Serializes a <see cref="CreateItemDiscountRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createItemDiscountRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateItemDiscountRequest createItemDiscountRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createItemDiscountRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateItemDiscountRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createItemDiscountRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateItemDiscountRequest createItemDiscountRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createItemDiscountRequest.Name == null)
                throw new ArgumentNullException(nameof(createItemDiscountRequest.Name), "Property is required for class CreateItemDiscountRequest.");

            writer.WriteString("name", createItemDiscountRequest.Name);

            if (createItemDiscountRequest.IsActiveOption.IsSet)
                if (createItemDiscountRequest.IsActiveOption.Value != null)
                    writer.WriteBoolean("isActive", createItemDiscountRequest.IsActiveOption.Value!.Value);
                else
                    writer.WriteNull("isActive");

            if (createItemDiscountRequest.ParentIdOption.IsSet)
                if (createItemDiscountRequest.ParentIdOption.Value != null)
                    writer.WriteString("parentId", createItemDiscountRequest.ParentId);
                else
                    writer.WriteNull("parentId");

            if (createItemDiscountRequest.ParentNameOption.IsSet)
                if (createItemDiscountRequest.ParentNameOption.Value != null)
                    writer.WriteString("parentName", createItemDiscountRequest.ParentName);
                else
                    writer.WriteNull("parentName");

            if (createItemDiscountRequest.ItemDescOption.IsSet)
                if (createItemDiscountRequest.ItemDescOption.Value != null)
                    writer.WriteString("itemDesc", createItemDiscountRequest.ItemDesc);
                else
                    writer.WriteNull("itemDesc");

            if (createItemDiscountRequest.SalesTaxCodeIdOption.IsSet)
                if (createItemDiscountRequest.SalesTaxCodeIdOption.Value != null)
                    writer.WriteString("salesTaxCodeId", createItemDiscountRequest.SalesTaxCodeId);
                else
                    writer.WriteNull("salesTaxCodeId");

            if (createItemDiscountRequest.SalesTaxCodeNameOption.IsSet)
                if (createItemDiscountRequest.SalesTaxCodeNameOption.Value != null)
                    writer.WriteString("salesTaxCodeName", createItemDiscountRequest.SalesTaxCodeName);
                else
                    writer.WriteNull("salesTaxCodeName");

            if (createItemDiscountRequest.DiscountRateOption.IsSet)
                if (createItemDiscountRequest.DiscountRateOption.Value != null)
                    writer.WriteNumber("discountRate", createItemDiscountRequest.DiscountRateOption.Value!.Value);
                else
                    writer.WriteNull("discountRate");

            if (createItemDiscountRequest.DiscountRatePercentOption.IsSet)
                if (createItemDiscountRequest.DiscountRatePercentOption.Value != null)
                    writer.WriteNumber("discountRatePercent", createItemDiscountRequest.DiscountRatePercentOption.Value!.Value);
                else
                    writer.WriteNull("discountRatePercent");

            if (createItemDiscountRequest.AccountIdOption.IsSet)
                if (createItemDiscountRequest.AccountIdOption.Value != null)
                    writer.WriteString("accountId", createItemDiscountRequest.AccountId);
                else
                    writer.WriteNull("accountId");

            if (createItemDiscountRequest.AccountNameOption.IsSet)
                if (createItemDiscountRequest.AccountNameOption.Value != null)
                    writer.WriteString("accountName", createItemDiscountRequest.AccountName);
                else
                    writer.WriteNull("accountName");

            if (createItemDiscountRequest.ExternalIdOption.IsSet)
                if (createItemDiscountRequest.ExternalIdOption.Value != null)
                    writer.WriteString("externalId", createItemDiscountRequest.ExternalId);
                else
